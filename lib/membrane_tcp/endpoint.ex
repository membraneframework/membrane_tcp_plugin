defmodule Membrane.TCP.Endpoint do
  @moduledoc """
  Element that sends buffers received on the input pad over a TCP socket and
  reads packets from a TCP socket and sends their payloads through the output pad.
  """
  ...
  def_options destination_address: [
              ...
              local_address: [
                ...
                * An IP Address set for a TCP socket used to sent packets.
              ...
              local_port_no: [
                ...
                default: 0,
                description: """
                A TCP port number used when opening a receiving socket and for sending packets.
                """
              ],
              recv_buffer_size: [
                spec: pos_integer(),
