defmodule Membrane.TCP.IntegrationTest do
  ...
  test "send and receive using 2 pipelines" do
    ...
    receiver =
      Pipeline.start_link_supervised!(
        spec: [
          child(:source, %TCP.Source{local_port_no: @target_port, local_address: @localhostv4})
  ...
  test "NAT pierce datagram comes through" do
    {:ok, server_sock} =
      TCP.Socket.connect(%TCP.Socket{port_no: @server_port, ip_address: @localhostv4})
    ...
    assert_receive({:tcp, ^handle, @localhostv4, @target_port, <<>>}, 20_000)
  end
end
